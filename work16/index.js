//需要：鼠标经过盒子，显示遮罩和大图 鼠标移动的时候 让遮罩跟着移动让大图按照比例移动
...
$('smallBox').onmousemove = function (event) {
    var event = event || window.event;//处理兼容问题
    //鼠标在页面中的坐标
    ...
    if(maskY > $('smallBox').offsetWidth - $('mask').offsetHeight){
        maskY = $('smallBox').offsetWidth - $('mask').offsetHeight;
    }
    //修改遮罩的显示位置
